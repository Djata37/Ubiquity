...
const slider = document.querySelectorAll(".slide-ctn");
const card = document.querySelectorAll('.slide-ctn LI');
...
function getNextPrev() {
  const activeSlide = document.querySelector(".slide-card.active");
...
function getNextSlide() {
  ...
  const current = document.querySelector(".slide-card.active");
  const [next, prev] = getNextPrev();
